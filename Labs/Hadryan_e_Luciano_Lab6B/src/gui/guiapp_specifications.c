...
GX_CHECKBOX_PROPERTIES window1_buttonenable_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window1_buttonenable_define =
{
    "buttonenable",
    ...
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_buttonenable), /* control block    */
    (void *) &window1_buttonenable_properties /* extended properties           */
};
...
GX_CONST GX_STUDIO_WIDGET window1_windowchanger_define =
{
    ...
    &window1_buttonenable_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
