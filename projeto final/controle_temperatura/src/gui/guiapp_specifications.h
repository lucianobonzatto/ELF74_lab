...
#define ID_START 7
#define ID_SAIDA_VIDRO 8
#define ID_SAIDA_PAINEL 9
#define ID_SAIDA_PES 10
#define ID_TEMP_ATUAL 11
#define ID_VALVULA_QUENTE 12
#define ID_VALVULA_FRIA 13
#define ID_PROMPT_VIDRO 14
#define ID_PROMPT_PAINEL 15
#define ID_PROMPT_PES 16
#define ID_TEMP_DESEJADA 17
#define ID_RUNNING 18
#define ID_TEMP_ALVO 19
#define ID_TEMP_DESEJADA_DECIMAL 20
#define ID_TEMP_ATUAL_DECIMAL 21
#define ID_TEMP_ALVO_DECIMAL 22
...
typedef struct WINDOW1_CONTROL_BLOCK_STRUCT
{
    ...
    GX_TEXT_BUTTON window1_start_button;
    GX_TEXT_BUTTON window1_saida_vidro_button;
    GX_TEXT_BUTTON window1_saida_painel_button;
    GX_TEXT_BUTTON window1_saida_pes_button;
    GX_NUMERIC_PROMPT window1_temp_atual;
    GX_PROMPT window1_prompt_d;
    GX_PROMPT window1_prompt_a;
    GX_PROMPT window1_prompt_vidro;
    GX_PROMPT window1_prompt_painel;
    GX_PROMPT window1_prompt_pes;
    ...
    GX_PROMPT window1_prompt_vidro_out;
    GX_PROMPT window1_prompt_painel_out;
    GX_PROMPT window1_prompt_pes_out;
    GX_NUMERIC_PROMPT window1_temp_desejada;
    GX_PROMPT window1_prompt_running;
    GX_NUMERIC_PROMPT window1_temp_alvo;
    GX_PROMPT window1_prompt_1;
    GX_NUMERIC_PROMPT window1_temp_desejada_decimal;
